...
def get_config(url, razdel=0):
	id = re.findall('view/(.*)',url)[0]	
	
	if    razdel == 0:
		c_url = 'http://kset.kz/cinema/config?id=' + id + '_0&cv=1&ref=' + url		
	elif razdel == 1:
		# http://kset.kz/v.php?id=32814370_0_0&cv=1&ref=http://kset.kz/video/view/32814370
		c_url = 'http://kset.kz/v.php?id=' + id + '_0_0&cv=1&ref=' + url	
